    ...
    @assistant = Langchain::Assistant.new(
      ...
      instructions: <<~PROMPT.strip,
        ...
        - 'search_products_by_images':
            ใช้เฉพาะเมื่อมีข้อความที่แสดงความต้องการซื้อหรือค้นหาสินค้าเท่านั้น และต้องมี URL ภาพ (ลงท้าย .jpg/.jpeg/.png/.gif ฯลฯ), data URI base64 เท่านั้น
            1. ต้องมี ข้ดความ และข้ดความแสดงความต้องการซื้อหรือค้นหาสินค้าเท่านั้น
            2. ต้องมี รูปภาพ
            ต้องทีครบทั้ง 2 ข้อ
